...
def start_docker_container(ip_address, username, password, mode, ticker, domain):
    ...
    -v /root/tokens/{mode}_{ticker}/dist:/usr/share/nginx/html:ro \
    ...
    nginx
    """
    ssh.exec_command(docker_command)
    ssh.close()
...
def main(json_file_path):
    ...
    upload_and_unpack(ip_address, username, password, output_filename, f"/root/tokens/{mode}_{ticker}")
